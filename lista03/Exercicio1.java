...
public class Exercicio1 {
    ...
    public static void main(String[] args) {
        ...
        // método addAll adiciona no vetor os elementos do vetor que foi passado como
        // argumento do método;
        ...
        // método indexOf retorna posição da primeira ocorrência do elemento, ou -1 se
        // não encontrar;
        // retorna um valor inteiro

        System.out.println("posição no vetor: " + lista.indexOf(3));

        // método lastIndexOf retorna posição da última ocorrência do elemento, ou -1 se
        // não encontrar;
        // retorna um valor inteiro

        System.out.println("posição no vetor: " + lista.lastIndexOf(3));

        // método retainAll mantém no vertor apenas os elementos que estão armazenados
